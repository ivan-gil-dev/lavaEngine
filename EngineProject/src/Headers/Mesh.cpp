...
void Engine::Mesh::LoadModel(std::string modelPath) {
    ...
    //То изменяется размер вектора Faces в соответствии с кол-вом материалов//
    //Затем в каждый элемент вектора Faces загружаются пути к текстурам и идентификатор//
    ...
    for (size_t s = 0; s < shapes.size(); s++) {
        ...
        for (size_t f = 0; f < shapes[s].mesh.num_face_vertices.size(); f++) {
            ...
            for (size_t v = 0; v < fv; v++) {
                ...
                //Запись индексов в разные элементы вектора Faces
