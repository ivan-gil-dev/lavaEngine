...
void Engine::GraphicsPipelineForCubemapObjects::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo, VkDescriptorSetLayout setLayout, VkRenderPass renderPass)
{
...
void Engine::GraphicsPipelineForShadowMap::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo, VkDescriptorSetLayout setLayout, VkRenderPass renderPass)
{
