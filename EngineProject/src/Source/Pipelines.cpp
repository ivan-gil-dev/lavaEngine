...
void Engine::RenderPass::CreateRenderPass(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo, VkFormat depthImageFormat)
{
...
void Engine::RenderPass::Destroy(VkDevice device)
{
    vkDestroyRenderPass(device, vRenderPass, nullptr);
}

VkRenderPass Engine::ShadowMapOffscreenRenderPass::GetRenderPass()
{
    return vRenderPass;
}

void Engine::ShadowMapOffscreenRenderPass::CreateRenderPass(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo, VkFormat depthImageFormat)
{
...
void Engine::ShadowMapOffscreenRenderPass::Destroy(VkDevice device)
{
    vkDestroyRenderPass(device, vRenderPass, nullptr);
}

VkPipeline* Engine::GraphicsPipeline::PGetGraphicsPipeline()
{
    return &vGraphicsPipeline;
}

VkPipeline Engine::GraphicsPipeline::Get()
{
    return vGraphicsPipeline;
}

VkPipelineLayout Engine::GraphicsPipeline::GetPipelineLayout()
{
    return PipelineLayout;
}

VkShaderModule Engine::GraphicsPipeline::CreateShaderModule(VkDevice device, std::vector<char>& code)
{
...
std::vector<char> Engine::GraphicsPipeline::ReadShader(std::string path)
{
...
void Engine::GraphicsPipelineForMesh::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo,
...
void Engine::GraphicsPipelineForMesh::DestroyPipelineObjects(VkDevice device)
{
    vkDestroyPipelineLayout(device, PipelineLayout, nullptr);
    vkDestroyPipeline(device, vGraphicsPipeline, nullptr);
}

void Engine::GraphicsPipelineForCubemapObjects::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo,
    VkDescriptorSetLayout setLayout, VkRenderPass renderPass)
{
...
void Engine::GraphicsPipelineForCubemapObjects::DestroyPipelineObjects(VkDevice device)
{
    vkDestroyPipelineLayout(device, PipelineLayout, nullptr);
    vkDestroyPipeline(device, vGraphicsPipeline, nullptr);
}

void Engine::GraphicsPipelineForRigidBodyMesh::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo, VkDescriptorSetLayout setLayout, VkRenderPass renderPass)
{
...
void Engine::GraphicsPipelineForRigidBodyMesh::DestroyPipelineObjects(VkDevice device)
{
    vkDestroyPipelineLayout(device, PipelineLayout, nullptr);
    vkDestroyPipeline(device, vGraphicsPipeline, nullptr);
}

void Engine::GraphicsPipelineForShadowMap::CreateGraphicsPipeline(VkDevice device, VkSwapchainCreateInfoKHR swapchainCreateInfo,
    VkDescriptorSetLayout setLayout, VkRenderPass renderPass)
{
...
void Engine::GraphicsPipelineForShadowMap::DestroyPipelineObjects(VkDevice device)
{
    vkDestroyPipelineLayout(device, PipelineLayout, nullptr);
    vkDestroyPipeline(device, vGraphicsPipeline, nullptr);
}