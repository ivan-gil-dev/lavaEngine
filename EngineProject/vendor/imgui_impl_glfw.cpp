...
static GlfwClientApi        gClientApi = GlfwClientApi_Unknown;
...
static bool                 gInstalledCallbacks = false;

// Chain GLFW callbacks: our callbacks will call the user's previously installed callbacks, if any.
static GLFWmousebuttonfun   gPrevUserCallbackMousebutton = NULL;
static GLFWscrollfun        gPrevUserCallbackScroll = NULL;
static GLFWkeyfun           gPrevUserCallbackKey = NULL;
static GLFWcharfun          gPrevUserCallbackChar = NULL;
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    {
        gInstalledCallbacks = true;
        gPrevUserCallbackMousebutton = glfwSetMouseButtonCallback(window, ImGui_ImplGlfw_MouseButtonCallback);
        gPrevUserCallbackScroll = glfwSetScrollCallback(window, ImGui_ImplGlfw_ScrollCallback);
        gPrevUserCallbackKey = glfwSetKeyCallback(window, ImGui_ImplGlfw_KeyCallback);
        gPrevUserCallbackChar = glfwSetCharCallback(window, ImGui_ImplGlfw_CharCallback);
    }
...
void ImGui_ImplGlfw_Shutdown()
{
    ...
    gClientApi = GlfwClientApi_Unknown;
}
