...
namespace Lava{
	/*
		VkDescriptorSetLayout связывает номера binding'ов шейдера в GPU
		с дескрипторами в CPU
	*/
	...
	class DescriptorSetLayoutForMesh : public DescriptorSetLayout {
		...
		void CreateDescriptorSetLayout(VkDevice device) {
			...
			//
			{
				...
				spotlightBinding.descriptorCount = MAX_SPOTLIGHTS;
			...
			//VkDescriptorSetLayoutBinding materialBinding2{};
			////
			//{
