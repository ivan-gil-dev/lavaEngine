...
namespace Lava{
	...
	class DescriptorSetLayoutForGameObjects : public DescriptorSetLayout {
	public:
	...
	class DescriptorSetLayoutForPointLightObjects : public DescriptorSetLayout {
	public:
		void createDescriptorSetLayoutForPointLightObjects(VkDevice device) {
			std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings;
			VkDescriptorSetLayoutBinding mvpBinding{};
			mvpBinding.binding = 0;
			mvpBinding.descriptorCount = 1;
			...
			VkDescriptorSetLayoutBinding lightColorBinding{};
			lightColorBinding.binding = 2;
			lightColorBinding.descriptorCount = 1;
			lightColorBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
			lightColorBinding.pImmutableSamplers = nullptr;
			lightColorBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;
			setLayoutBindings.push_back(lightColorBinding);
